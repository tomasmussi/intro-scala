...
class RecFunSuite {
  ...
  @Test def `countChange: short example`: Unit =
    assertEquals(4, countChange(4,List(1,2,3)))

  @Test def `countChange: another example`: Unit =
    assertEquals(5, countChange(10,List(2,5,3,6)))
